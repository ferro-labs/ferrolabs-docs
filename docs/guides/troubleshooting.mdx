...
description: "Diagnose Ferro AI Gateway errors: model_not_found vs upstream_unavailable, circuit breakers, MCP stdio tool calls, A/B weights, and Prometheus scraping."
