---
title: Changelog
description: Release history for the Ferro Labs AI Gateway — new providers, routing strategies, plugins, MCP integration, performance improvements, and bug fixes across all versions.
