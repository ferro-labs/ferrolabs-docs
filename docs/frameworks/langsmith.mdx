---
title: LangSmith
description: "Bridge Ferro Labs AI Gateway to LangSmith for unified LLM observability — one trace_id becomes one LangSmith run, with no per-provider SDK wiring."
