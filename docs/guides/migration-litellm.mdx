...
description: "Replace LiteLLM with the Ferro Labs AI Gateway — swap the base URL and API key, convert provider configs, and keep your retry and fallback logic."
...
| Load balancing | `routing_strategy: simple-shuffle` | `strategy: {mode: load-balance}` |
...
|---|---|
| `simple-shuffle` | `load-balance` |
| `least-busy` | `load-balance` |
