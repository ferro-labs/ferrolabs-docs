...
description: Monitor Ferro AI Gateway with authenticated Prometheus scraping, split /livez /readyz /health probes, and alert rules validated against the v1.4 metric surface.
