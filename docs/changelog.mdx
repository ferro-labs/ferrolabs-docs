---
title: Changelog
description: "Release history for Ferro Labs AI Gateway v0.4.5 through v1.5.1: the v1.5.1 routing correction, the importable v1.5.0 runtime, and the v1.4.0 routing pipeline."
keywords: [AI gateway changelog, LLM proxy releases, AI gateway version history, AI gateway v1.5.1, model_map, failover-safe routing, AI gateway v1.4.0 breaking changes, embedded dashboard, unified routing pipeline, MCP stdio transport, OpenTelemetry tracing, gateway updates]
---

Full release notes are also on [GitHub Releases](https://github.com/ferro-labs/ai-gateway/releases). **v1.5.1 is the latest tag.**
