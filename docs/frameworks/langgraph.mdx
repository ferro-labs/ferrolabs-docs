---
title: LangGraph
description: "Build LangGraph agents that route each node to a different provider through one Ferro Labs AI Gateway endpoint — planner, coder, and summarizer on different LLMs."
